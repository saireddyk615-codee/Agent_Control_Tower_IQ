...
exports.WatchtowerCodeActionProvider = void 0;
const vscode = __importStar(require("vscode"));
class WatchtowerCodeActionProvider {
    static kinds = [vscode.CodeActionKind.QuickFix];
    provideCodeActions(_document, _range, context) {
        if (!context.diagnostics.some((diagnostic) => diagnostic.source === "Agent Watchtower"))
            return [];
        const actions = [];
...
exports.WatchtowerCodeActionProvider = WatchtowerCodeActionProvider;
